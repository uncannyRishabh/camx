...
//                    zoom_level = 1;
    ...
    private View.OnTouchListener touchListener = new View.OnTouchListener(){
        @Override
        public boolean onTouch(View v, MotionEvent event) {
            if(tvPreview.isInTouchMode()){
                tvPreview.performClick();
            }
    ...
    private void inflateButtonMenu() {
        ...
        if (cachedHeight == appbar.getHeight()) {
            ...
            settings.animate().rotation(-90f).setInterpolator(new DecelerateInterpolator());
...
//                            Log.e(TAG, "getHighestResolution: resolution coeff float : "+((float) resolution.getWidth()/resolution.getHeight())%.2f);
    ...
    public void setCameraId(String cameraId) {
        MainActivity.cameraId = cameraId;
    }
...
//                logtext.setText(msg);
        ...
        Toast.makeText(MainActivity.this, "COMPLETE EXECUTION cam_aux()", Toast.LENGTH_SHORT).show();
    }
